...
/* * ******************************************
 * Controller Name  : MobilesavvyV2Controller *
 * Date Of Creation : 04/01/2016              *
 * Created By       : Selvakumar Rathinam     *
 * ****************************************** */
// error_reporting(0);
class MobilesavvyV2Controller extends AppController {
    ...
    public function orderRestaurantDetails($restaurant) {
        ...
        foreach ($slideshows as $slideshow) {
            ...
            $slideshow['path'] = 'https://www.tablesavvy.com/img/original/' . $sliderImageName;
            $slideshow['small'] = 'https://www.tablesavvy.com/img/small/' . $sliderImageName;
            $slideshow['medium'] = 'https://www.tablesavvy.com/img/medium/' . $sliderImageName;
            $slideshow['big'] = 'https://www.tablesavvy.com/img/big/' . $sliderImageName;
            $slideshow['application'] = 'https://www.tablesavvy.com/img/TSapplication/' . $sliderImageName;
...
//        $this->params['form']['store'] = '1';
     ...
     * Date Of Creation : 20/5/2016                              *
     * Purpose of action: To get current version of android app.*
     * Created By       : Selvakumar.R                          *
     * ********************************************************** */

    public function androidversion() {
        $this->loadModel('User');
        // Check the last inserted id androidversion, if it's older, then dynamically change into 3
        $userExists = $this->User->find('first', array('fields' => array('android_version'),
            'order' => array('User.id DESC'),
            'recursive' => -1));
         if($userExists['User']['android_version'] == "1"){
             $userExists['User']['android_version'] = "3";
         }
        $response['success'] = 1;
