    ...
    <div id="content" class="clearfix">
        ...
        <div class="content">							
            ...
            <div class="alertChicago">
                ...
                <!--Content-->
                <div class="popup-click popup_draghandle popup_2" id="popup_2" style="display: none;" onmouseover="showalert('popup_2')" onmouseout="hidealert('popup_2')">
                    ...
                    <div class="popup-inside">
                        ...
                        <ul class="popup-list">
                            <li><?php echo $form->input('Alert.sunday',array('checked'=>$sunday,'label'=>false,'class'=>'checkbox','div'=>false));?>Sunday</li>
                            <li><?php echo $form->input('Alert.monday',array('checked'=>$monday,'label'=>false,'class'=>'checkbox','div'=>false));?>Monday</li>
                            <li><?php echo $form->input('Alert.tuesday',array('checked'=>$tuesday,'label'=>false,'class'=>'checkbox','div'=>false));?>Tuesday</li>
                            <li><?php echo $form->input('Alert.wednesday',array('checked'=>$wednesday,'label'=>false,'class'=>'checkbox','div'=>false));?>Wednesday</li>
                            <li><?php echo $form->input('Alert.thursday',array('checked'=>$thursday,'label'=>false,'class'=>'checkbox','div'=>false));?>Thursday</li>
                            <li><?php echo $form->input('Alert.friday',array('checked'=>$friday,'label'=>false,'class'=>'checkbox','div'=>false));?>Friday</li>
                            <li><?php echo $form->input('Alert.saturday',array('checked'=>$saturday,'label'=>false,'class'=>'checkbox','div'=>false));?>Saturday</li>					
                        </ul>
                        <?php echo $ajax->submit('Update', array(
                            'url'=>array('controller'=>'alerts','action'=>'day_select'),
                            'class'=>'btn btn-large btn-success popup_closebox',
                            'update'=>'post',
                            'complete'=>'funcall()',
                            'escape'=>false)); 
                        ?>
