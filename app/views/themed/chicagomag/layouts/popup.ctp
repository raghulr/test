...
<div id="page-container">
    ...
    <div id="page-body-right" class="reservation_details">
        <div class="fb_sign" id='fb_sign'>
            ...
            ?>
            <a href="<?php echo $html->url(array('controller'=>'users','action'=>'register'),true); ?>"  class="color_sign">Not a member? Sign up!</a> <?php if($this->params['action']!='login'){ ?>| 
            <?php  
