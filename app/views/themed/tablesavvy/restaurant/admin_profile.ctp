            ...
            <div class="bot_cont">
                ...
                <div class="content_bot">
                	<div class="left">
						...
						<?php echo $form->input('city',array('label'=>'City:','class'=>'left_text_sel','type'=>'select','options'=>$city_name,'onchange' =>'changeneighboor(this.value,"'.$city_url.'");')); ?>
                            </div>
                            ...
                            <div class="lab_text"><?php echo $form->input('url',array('label'=>'Website:','class'=>'left_text','type'=>'text','onchange'=>'return showFields(value)')); ?></div>
                            <div class="lab_text" id="neigh"><?php echo $form->input('neighborhoodId',array('label'=>'Neighborhood','type'=>'select','class'=>'left_text_sel','empty'=>'Select neighborhood','options'=>$neigh_name_list,'selected'=>$this->data['Restaurant']['neighborhoodId'])); ?></div>
                            <div class="cus_name_select">
                                <label class="cusin" id="cusin_title">Cuisine:</label> 
                                <div class="cus_name">
                                    <fieldset id="field">
                                 <p style="float:left; width:auto;"><legend id="change_cusine">   
                               <?php 
							   if(!empty($cuisines)):foreach($cuisines as $cuname): ?>
									<?php echo $cuname;?>
                                 <?php endforeach; endif; ?>
                                  </p>
                                     </legend>
                                     <div class="edit_but">
                                      <?php echo $html->link('SELECT',array('controller'=>'cuisines','action'=>'index'),array('class'=>'colorbox-edit'));?>
                                     </div>
                                     </fieldset>
                                    </div>
                            </div>
                            ...
                            <?php //if(!isset($menu)){?>
                            <div class="lab_text"><?php echo $form->input('menu_link',array('label'=>'Menu:','class'=>'left_text','type'=>'text')); ?></div>
                            <?php //} ?>
                          ...
                          <div class="sample">
                            ...
                            <?php }else{ ?>
							  <a href="javascript:;"><?php echo $html->image('/images/view_menu.png',array('border'=>0));?></a>	
							 <?php } ?>
                            </div>
							...
							<?php  echo $form->submit('',array('class'=>'upload_but','id'=>'updat_prof','label'=>false)); ?>
                        </div>
                        <div class="right">
                         <div id="update_image_logo">
                            <?php 
                            //, 'height'=>435, 'width'=>400
                            if(!empty($image_path)){echo $html->image('big/'.$image_path,array('border'=>0,'class'=>'pro_logo', 'width'=>300));}?>
                            </div>
                            ...
                            <div id="up_right_but" style="width:182px; height:14px; color:#fff; border-radius:5px; background-color:#81B309;
                            padding:10px 0px 8px 23px; font-size:13px; margin:18px 54px 0 54px;float:left"> 
                             <a style="text-decoration:none; color:#fff;" id="sub_rem" onclick="return edit_p(event);" href="<?php echo $html->url(array('controller'=>'restaurants','action'=>'edit_email'),true); ?>" class="colorbox-add"><b>UPDATE EMAIL ADDRESS</b> </a> </div> 
                            <div id="up_right_but" style="width:182px; height:14px; color:#fff; border-radius:5px; background-color:#81B309;
                            padding:10px 0px 8px 23px; font-size:13px; margin:18px 54px 0 54px;float:left"> 
                             <a style="text-decoration:none; color:#fff;margin-left: -8px;" id="sub_rem" onclick="return edit_p(event);" href="<?php echo $html->url(array('controller'=>'restaurants','action'=>'add_email'),true); ?>" class="colorbox-add"><b>UPDATE EMAIL RECIPIENTS</b> </a> </div> 
                             <!--<div id="up_right_but" style="width:182px; height:14px; color:#fff; border-radius:5px; background-color:#9f0101;
                            padding:10px 0px 8px 23px; font-size:13px; margin:18px 54px 0 54px;float:left"> 
                             <a style="text-decoration:none; color:#fff;" id="sub_rem" onclick="return edit_p(event);" href="<?php echo $html->url(array('controller'=>'restaurants','action'=>'remove_email'),true); ?>" class="colorbox-add"><b>REMOVE EMAIL ADDRESS</b> </a> </div>  -->                              
