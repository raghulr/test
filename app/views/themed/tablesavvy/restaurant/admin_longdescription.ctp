...
<?php echo $form->create();
	  ...
	  <div class="pop_editor"><?php echo $form->input('Restaurant.long_description',array('class'=>'js-editor','label'=>false)); ?></div>
<?php echo $form->submit('UPDATE',array('class'=>'upload_but','id'=>'up_align','label'=>false));
	  echo $form->end();
?>	  	
</div>
</div>