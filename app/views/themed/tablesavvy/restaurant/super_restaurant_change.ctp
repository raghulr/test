<?php 
if($count>=10){?>
	<script language="javascript">$('#nor_page').show();</script>
<?php }else{?>
	<script language="javascript">$('#nor_page').hide();</script>
<?php }
?>
                        ...
                        <div class="time" id="rest_no4">
                        	<span id="neigh_name1">
                        	 	<?php 
									...
									if(empty($ser_term))
										$ser_term=0;
									$time_url = $html->url(array('controller'=>'restaurants','action'=>'super_res_del',$rest_id,$sel_id,$ser_term,$page),true); ?>
