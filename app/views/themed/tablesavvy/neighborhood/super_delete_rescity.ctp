...
<span id="neigh_name">
	...
	<?php $ucurl = $html->url(array('controller'=>'neighborhoods','action'=>'super_update_rescity','super'=>true,$page),true); ?>	
    <?php $dcurl = $html->url(array('controller'=>'neighborhoods','action'=>'super_delete_rescity','super'=>true,$page),true); ?>	
    <?php $rcurl = $html->url(array('controller'=>'neighborhoods','action'=>'super_revert_rescity','super'=>true,$page),true); ?>	
   ...
   <!-- <a href="javascript:void(0)" id="cuisine_link" onClick="return delete_rescity('form_<?php //echo $name['City']['id']; ?>','<?php echo $dcurl;?>')">Delete</a>  -->
