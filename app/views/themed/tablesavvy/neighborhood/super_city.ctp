...
<script>
jQuery("#paginate a").click(function(){
    var neighborhood_city_id = jQuery('#NeighborhoodCityId').val();
    var location = this.href+'/city:'+neighborhood_city_id;
    jQuery(".tabl_cont").load(location);
    return false;
});
</script>        
