...
<div class="navi_content">
	...
	<div class="drop_down">
		<?php echo $form->create(); 
			  ...
			  echo $form->input('Show Active Reservations',array('label'=>false, 'class'=>'select_box','type'=>'select','options'=>array('1'=>'Show All Reservations','2'=>'Active reservations','3'=>'Canceled reservations'),'selected'=>1,'onchange' =>'changereserve(this.value,"'.$changeurl.'");')); ?>
	</div>
    <div class="res_tabl">
    	<div class="tabl_head my_time">
        ...
        <div class="tabl_cont" id="post">
        	<div class="fist_row my_time">
			 ...
			 ?>
              ...
              <?php } else { ?>   
                <div class="seat"> 
                   <?php /*?> <?php echo $ajax->link($html->image("/images/ad_select.png"),array('controller'=>'reservations','action'=> 'approved',$resid,$userid),array('update'=>'post','escape'=>false,'class'=>'approve','complete'=>'funcall()','confirm'=>'Are you sure to cancel this reservation?')); ?><?php */?>
                   <?php echo $html->image('/images/ad_select.png',array('class'=>'approve'));?>
                </div>
