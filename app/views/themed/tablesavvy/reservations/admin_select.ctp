...
<div class="navi_content">
	<div class="drop_down">
		<?php echo $form->create(); 
			  ...
			  echo $form->input('Show Active Reservations',array('label'=>false, 'class'=>'select_box','type'=>'select','options'=>array('1'=>'Show All Reservations','2'=>'Active reservations','3'=>'Canceled reservations'),'default'=>2,'onchange' =>'changereserve(this.value,"'.$changeurl.'");')); ?>
	</div>
        <div class="res_tabl">
