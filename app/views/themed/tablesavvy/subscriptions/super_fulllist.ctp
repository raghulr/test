...
<div id="changedate">
    ...
    <div class="navi_content" id="change">
        ...
        <div class="res_tabl">
            ...
            <div class="tabl_cont" id="change_city" style="height:527px;overflow-y:scroll;overflow-x:hidden;">
                ...
                ?>
                	<div class="<?php if($class=='fist_row'):echo $class;$class='sec_row';else:echo $class;$class='fist_row';endif;?>">
                        ...
                        <div class="time" id="rest_no_user">
                        	<span id="neigh_name1" title="<?php echo $data['Subscription']['email'];?>"><?php echo (strlen($data['Subscription']['email'])>30)?substr($data['Subscription']['email'],0,25).'..':$data['Subscription']['email']; ?></span>
                        </div>
